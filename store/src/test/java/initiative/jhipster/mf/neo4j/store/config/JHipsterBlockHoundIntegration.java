...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("initiative.jhipster.mf.neo4j.store.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside(
            "initiative.jhipster.mf.neo4j.store.security.DomainUserDetailsService",
