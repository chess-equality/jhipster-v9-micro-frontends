  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button as={Link as any} to="/store/product" replace variant="info" data-cy="entityDetailsBackButton">
        ...
        &nbsp;
        <Button as={Link as any} to={`/store/product/${productEntity.id}/edit`} replace variant="primary">
