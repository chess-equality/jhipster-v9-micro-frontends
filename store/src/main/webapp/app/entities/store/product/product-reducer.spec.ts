...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_PRODUCT actions', async () => {
      const arg = { id: '2150899e-b136-4a5a-9619-910ef7895436' };
    ...
    it('dispatches UPDATE_PRODUCT actions', async () => {
      const arg = { id: '2150899e-b136-4a5a-9619-910ef7895436' };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCT actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PRODUCT actions', async () => {
      const arg = 42666;
