            ...
            <tbody>
              {productList.map(product => (
                <tr key={`entity-${product.id}`} data-cy="entityTable">
                  <td>
                    <Button as={Link as any} to={`/store/product/${product.id}`} variant="link" size="sm">
                      {product.id}
                    </Button>
                  </td>
                  <td>{product.title}</td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button as={Link as any} to={`/store/product/${product.id}`} variant="info" size="sm" data-cy="entityDetailsButton">
                      ...
                      <Button
                        onClick={() =>
                          (globalThis.location.href = `/store/product/${product.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        variant="danger"
                        size="sm"
