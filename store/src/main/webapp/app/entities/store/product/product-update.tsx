  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.storeProduct.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
            <Translate contentKey="storeApp.storeProduct.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.storeProduct.title')}
                id="product-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.storeProduct.price')}
                id="product-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              />
              <ValidatedBlobField
                label={translate('storeApp.storeProduct.image')}
                id="product-image"
                name="image"
                data-cy="image"
                isImage
                accept="image/*"
              />
              <Button as={Link as any} id="cancel-save" data-cy="entityCreateCancelButton" to="/store/product" replace variant="info">
