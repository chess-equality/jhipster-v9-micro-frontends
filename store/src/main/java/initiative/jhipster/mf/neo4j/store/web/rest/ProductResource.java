package initiative.jhipster.mf.neo4j.store.web.rest;

import initiative.jhipster.mf.neo4j.store.domain.Product;
import initiative.jhipster.mf.neo4j.store.repository.ProductRepository;
import initiative.jhipster.mf.neo4j.store.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link initiative.jhipster.mf.neo4j.store.domain.Product}.
 */
@RestController
...
public class ProductResource {
    ...
    public Mono<ResponseEntity<Product>> createProduct(@Valid @RequestBody Product product) throws URISyntaxException {
        ...
        return productRepository.save(product).map(result -> {
            try {
    ...
    public Mono<ResponseEntity<Product>> partialUpdateProduct(
        ...
        return productRepository.existsById(id).flatMap(exists -> {
            ...
            Mono<Product> result = productRepository
                ...
                .map(existingProduct -> {
                    updateIfPresent(existingProduct::setTitle, product.getTitle());
                    updateIfPresent(existingProduct::setPrice, product.getPrice());
                    updateIfPresent(existingProduct::setImage, product.getImage());
                    updateIfPresent(existingProduct::setImageContentType, product.getImageContentType());
