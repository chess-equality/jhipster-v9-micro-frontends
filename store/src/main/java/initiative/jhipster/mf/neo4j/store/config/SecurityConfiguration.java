package initiative.jhipster.mf.neo4j.store.config;

import static org.springframework.security.config.Customizer.withDefaults;
import static org.springframework.security.oauth2.core.oidc.StandardClaimNames.PREFERRED_USERNAME;
import static org.springframework.security.web.server.util.matcher.ServerWebExchangeMatchers.pathMatchers;

import initiative.jhipster.mf.neo4j.store.security.AuthoritiesConstants;
import initiative.jhipster.mf.neo4j.store.security.SecurityUtils;
import initiative.jhipster.mf.neo4j.store.security.oauth2.AudienceValidator;
import initiative.jhipster.mf.neo4j.store.web.filter.SpaWebFilter;
