...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POST actions', async () => {
      const arg = { id: 'b0ed8852-431a-45ab-8c51-ab3b9a46e59d' };
    ...
    it('dispatches UPDATE_POST actions', async () => {
      const arg = { id: 'b0ed8852-431a-45ab-8c51-ab3b9a46e59d' };
    ...
    it('dispatches PARTIAL_UPDATE_POST actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_POST actions', async () => {
      const arg = 42666;
