...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BLOG actions', async () => {
      const arg = { id: '0b7b7e1b-829e-42cc-b398-3eae2463fe73' };
    ...
    it('dispatches UPDATE_BLOG actions', async () => {
      const arg = { id: '0b7b7e1b-829e-42cc-b398-3eae2463fe73' };
    ...
    it('dispatches PARTIAL_UPDATE_BLOG actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_BLOG actions', async () => {
      const arg = 42666;
