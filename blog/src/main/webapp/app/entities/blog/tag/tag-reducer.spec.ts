...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TAG actions', async () => {
      const arg = { id: '5a0a2837-7a7b-4933-be56-a0b190ca7642' };
    ...
    it('dispatches UPDATE_TAG actions', async () => {
      const arg = { id: '5a0a2837-7a7b-4933-be56-a0b190ca7642' };
    ...
    it('dispatches PARTIAL_UPDATE_TAG actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_TAG actions', async () => {
      const arg = 42666;
