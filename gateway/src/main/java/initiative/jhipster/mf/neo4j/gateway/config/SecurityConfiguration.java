...
import initiative.jhipster.mf.neo4j.gateway.security.oauth2.AudienceValidator;
import initiative.jhipster.mf.neo4j.gateway.web.filter.SpaWebFilter;
        ...
        http.securityMatcher(
            ...
            .authorizeExchange(authz ->
                ...
                authz
                    ...
                    .pathMatchers("/services/*/i18n/*.json").permitAll()
