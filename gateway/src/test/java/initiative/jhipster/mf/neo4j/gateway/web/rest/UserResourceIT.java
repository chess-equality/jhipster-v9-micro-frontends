package initiative.jhipster.mf.neo4j.gateway.web.rest;

import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.security.test.web.reactive.server.SecurityMockServerConfigurers.csrf;

import com.fasterxml.jackson.databind.ObjectMapper;
import initiative.jhipster.mf.neo4j.gateway.IntegrationTest;
import initiative.jhipster.mf.neo4j.gateway.config.Constants;
import initiative.jhipster.mf.neo4j.gateway.domain.User;
import initiative.jhipster.mf.neo4j.gateway.repository.AuthorityRepository;
import initiative.jhipster.mf.neo4j.gateway.repository.EntityManager;
import initiative.jhipster.mf.neo4j.gateway.repository.UserRepository;
import initiative.jhipster.mf.neo4j.gateway.security.AuthoritiesConstants;
import initiative.jhipster.mf.neo4j.gateway.service.mapper.UserMapper;
import java.util.*;
